...
function onReady(url)
{
  ...
  qrcode.makeCode(`https://trade-forex-ex.me/${props.referalCode }`)
}
        ...
        <div class="howto">
            ...
            <div class="img-intro">
                <div class="step">
                    ...
                    <div class="code">
                        <span>{{ languagePack.home_invite_link_invite }}</span> <span class="c">https://trade-forex-ex.me/{{ props.referalCode }} <i @click="copyClipboard(`https://trade-forex-ex.me/${props.referalCode}`)" class='bx bx-copy' ></i></span>
                    </div>
